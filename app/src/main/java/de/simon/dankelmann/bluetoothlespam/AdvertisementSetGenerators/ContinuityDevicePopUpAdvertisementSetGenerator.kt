...
class ContinuityDevicePopUpAdvertisementSetGenerator: IAdvertisementSetGenerator {
    ...
    private fun getPrefixes(deviceIdentifier: String):Map<String, String>{
        if(deviceIdentifier == "0055" || deviceIdentifier == "0030"){
            return mapOf("05" to "New ") // New Airtag
        } else {
            return mapOf(
                "07" to "New ", // New Device
                "01" to "Not Your ", // Not your Device
            )
        }
    }
    ...
    override fun getAdvertisementSets(): List<AdvertisementSet> {
        ...
        deviceData.forEach{deviceData ->
            val prefixes = getPrefixes(deviceData.key)
            ...
            prefixes.forEach { prefix ->
                colorMap.forEach{ color ->
                    ...
                    advertisementSet.type = AdvertisementSetType.ADVERTISEMENT_TYPE_CONTINUITY_DEVICE_POPUPS
                    ...
                    // General Data
                    advertisementSet.title = prefix.value + " " + deviceData.value + " " + color.value
